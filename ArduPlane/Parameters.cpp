...
const AP_Param::Info Plane::var_info[] = {
    ...
    ASCALAR(stall_prevention, "STALL_PREVENTION",  0), //ZEF
    ...
    // @Values: 0:Manual,1:CIRCLE,2:STABILIZE,3:TRAINING,4:ACRO,5:FBWA,6:FBWB,7:CRUISE,8:AUTOTUNE,10:Auto,11:RTL,12:Loiter,13:TAKEOFF,14:AVOID_ADSB,15:Guided,17:QSTABILIZE,18:QHOVER,19:QLOITER,20:QLAND,21:QRTL,22:QAUTOTUNE,23:QACRO,24:THERMAL,25:Loiter to QLand,26:Hovering,27:Manual,28:Manual with filter
    // @User: Standard
    ...
    // @Values:26:Hovering,27:Manual,28:Manual with filter
    ...
    // @User: Advanced
    GSCALAR(initial_mode,        "INITIAL_MODE",      Mode::Number::HOVERING),
    ...
    /*
    // @Param: CAL_ROLL_MOT
    // @DisplayName: Cal roll mot
    // @Description: cal_roll_mot
    AP_GROUPINFO("ZEF_CAL_ROLL_MOT", 40, ParametersG2, cal_roll_mot, 0.3),
    
    // @Param: CAL_PITCH_MOT
    // @DisplayName: Cal pitch mot
    // @Description: cal_pitch_mot
    AP_GROUPINFO("ZEF_CAL_PITCH_MOT", 41, ParametersG2, cal_pitch_mot, 0.6),
    
    // @Param: CAL_YAW_MOT
    // @DisplayName: Cal yaw mot
    // @Description: cal_yaw_mot
    AP_GROUPINFO("ZEF_CAL_YALL_MOT", 42, ParametersG2, cal_yaw_mot, 0.6),
    
    // @Param: CAL_CIMA_BAIXO
    // @DisplayName: Cal cima baixo
    // @Description: cal_cima_baixo
    AP_GROUPINFO("ZEF_CAL_CIMA_BAIXO", 43, ParametersG2, cal_cima_baixo, 0.6),
    
    // @Param: CAL_ROLL_ESTAB
    // @DisplayName: Cal roll estab
    // @Description: cal_roll_estab
    AP_GROUPINFO("ZEF_CAL_ROLL_ESTAB", 44, ParametersG2, cal_roll_estab, 0.3),
    
    // @Param: CAL_DIR_ESQ
    // @DisplayName: Cal dir esq
    // @Description: cal_dir_esq
    AP_GROUPINFO("ZEF_CAL_DIR_ESQ", 45, ParametersG2, cal_dir_esq, 0.3),*/
...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Param: BALLONET_MIN
    // @DisplayName: Min balloon press diff
    // @Description: Minimal ballon pressure difference against atmosphere
    AP_GROUPINFO("ZEF_BALLO_MIN", 35, ParametersG2, min_balloon_pressure_diff, 1.0),
    
    // @Param: BALLONET_MAX
    // @DisplayName: Max balloon press diff
    // @Description: Maximal ballon pressure difference against atmosphere
    AP_GROUPINFO("ZEF_BALLO_MAX", 36, ParametersG2, max_balloon_pressure_diff, 5.0),
    
    // @Param: BALLONET_ENABLE
    // @DisplayName: Enable ballonet
    // @Description: Enable/disable ballonet
    // @Range: 0 1
    AP_GROUPINFO("ZEF_BALLO_ENABLE", 37, ParametersG2, enable_ballonet, 1),
    
    // @Param: WIND_LOG_ENABLE
    // @DisplayName: Enable wind log
    // @Description: Enable/disable wind log
    // @Range: 0 1
    AP_GROUPINFO("ZEF_WIND_LOG", 38, ParametersG2, enable_wind_log, 0),
    
    // @Group: WNDVN_
    // @Path: ../libraries/AP_WindVane/AP_WindVane.cpp
    AP_SUBGROUPINFO(windvane, "WNDVN_", 39, ParametersG2, AP_WindVane),
    
    // @Param: ZEF_BALLO_DISABLE
    // @DisplayName: Disable one ballonet
    // @Description: Disable one ballonet by it's index (1 or 2)
    // @Range: 0 2
    //AP_GROUPINFO("ZEF_BALLO_DISABLE", 40, ParametersG2, ballonet_deactivated, 0),
